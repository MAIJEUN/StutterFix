...
| 장식 이동 최적화 | 장식을 즉시 옮기는 이벤트를 애니메이션 없이 바로 처리하고, 한 효과 안에서 장식마다 위치 마무리 계산을 한 번만 합니다. 측정: 장식 14,416개를 한 프레임에 옮기는 구간에서 148ms → 93ms. 결과 값은 게임과 비트 단위로 같은지 26만 개를 비교해 확인 |

    ...
    internal static class LogExport
    {
        ...
        private static string Report()
        {
            ...
            if (c != null)
            {
                ...
                sb.AppendLine("저사양: 우선순위 " + On(c.LowPriority) + ", 절전 제한 끄기 " + On(c.LowNoThrottle) + ", 음악 반응 계산 끄기 " + On(c.LowNoFft) + ", 게임 화면 해상도 " + c.LowRenderScale + "%, 필터 끄기 " + On(c.LowNoFilters) + ", 블룸 끄기 " + On(c.LowNoBloom));
